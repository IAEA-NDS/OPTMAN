...
C
      NTHREADS = omp_set_num_threads(16)
...
C
     ...
     *4HLE  ,4H    ,4HRID.,4HSOFT,4HSOFT,4H    ,4HDEFO,4HRMAT,4HIONS /
      ...
      II1=1
      IF(MEHAM.GT.1.OR.MEDEF.EQ.1.OR.MEAXI.EQ.1)      
  ...
  234      FORMAT(6I3) 
     ...
     *     MEDEIS(I),MEAXIS(I), I=1, MENUC)
      ...
      MEAXI=MEAXIS(IIS)
           ...
           IF(MEPOT.GT.1.OR.MEDEF.EQ.1.OR.MEAXI.EQ.1)
...
!$OMP END PARALLEL
      ...
      IF(MEPRI.LT.98) PRINT 160,ATIS(IIS), FI
...
C
  ...
  139 FORMAT(/1X,'FU=',E14.7,' starting next iteration'/)
      IF(NPJ(63).EQ.1.OR.NPJ(58).EQ.1 .AND. MEPRI.LT.98) PRINT 140,AMUO
